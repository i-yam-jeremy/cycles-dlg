...
build/Release/bin/cycles --samples 1000 --device OPTIX --output image.png "/media/jeremy/DRIVE/home/jeremy/Documents/island-usd-v2.0/island/usd/island.usda" --width 1024 --height 512

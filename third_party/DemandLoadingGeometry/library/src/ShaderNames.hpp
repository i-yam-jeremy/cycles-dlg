...
#define DEMANDLOADINGGEOMETRY_CHUNK_AH_SHADER_NAME __anyhit__DemandLoadingGeomtry_chunk
#define DEMANDLOADINGGEOMETRY_CHUNK_AH_SHADER_NAME_STRING TO_STRING(DEMANDLOADINGGEOMETRY_CHUNK_AH_SHADER_NAME)
...
namespace {
__global__ void populate_optix_instances(OptixInstance *instances, const demandLoadingGeometry::AffineXform *xforms, OptixTraversableHandle asHandle, int sbtOffset, int instanceCount) {
